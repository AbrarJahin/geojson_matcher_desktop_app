...
CELLS: tuple[tuple[str, str], ...] = (('notebook_cell_14.py',
 ...
 ('notebook_cell_32_safe_reject.py',
  '\n'
  '# ============================================================\n'
  '# 13) OLD EMPIRICAL-BAYES FUSION + GEOMETRY-SPECIALIZED SAFE REJECT\n'
  '# ============================================================\n'
  ...
  '# The thresholds below were calibrated and audited in notebook #6.\n'
  '# This production notebook applies those fixed thresholds and does not\n'
  ...
  'SAFE17_PARALLEL_THRESHOLD = float(SAFE_REJECT_PARALLEL_THRESHOLD)\n'
  'SAFE17_ORTHOGONAL_THRESHOLD = float(SAFE_REJECT_ORTHOGONAL_THRESHOLD)\n'
  '\n'
  'SAFE17_LOCAL_HALF_WINDOW_M = float(SAFE_REJECT_LOCAL_HALF_WINDOW_M)\n'
  'SAFE17_MIN_LOCAL_STRAIGHTNESS = float(\n'
  '    SAFE_REJECT_MIN_LOCAL_STRAIGHTNESS\n'
  ')\n'
  'SAFE17_MAX_LOCAL_CUMULATIVE_TURN_DEG = float(\n'
  '    SAFE_REJECT_MAX_LOCAL_CUMULATIVE_TURN_DEG\n'
  ')\n'
  'SAFE17_PARALLEL_MAX_HEADING_DIFF_DEG = float(\n'
  '    SAFE_REJECT_PARALLEL_MAX_HEADING_DIFF_DEG\n'
  ')\n'
  'SAFE17_ORTHOGONAL_MIN_HEADING_DIFF_DEG = float(\n'
  ...
  '    "global": SAFE17_GLOBAL_THRESHOLD,\n'
  '    "parallel": SAFE17_PARALLEL_THRESHOLD,\n'
  '    "orthogonal": SAFE17_ORTHOGONAL_THRESHOLD,\n'
  '}.items():\n'
  '    if not 0.0 <= threshold_value <= 1.0:\n'
  '        raise ValueError(\n'
  '            f"{threshold_name} Safe Reject threshold is outside [0, 1]."\n'
  '        )\n'
  '\n'
  'required_columns = [\n'
  '    GEOMETRIC_PROBABILITY_COL,\n'
  ...
  '    "geometry_county1",\n'
  '    "geometry_county2",\n'
  '    "county_1_contact_point",\n'
  '    "county_2_contact_point",\n'
  '    "heading_diff_deg",\n'
  '    "county_1_road_id",\n'
  '    "county_2_road_id",\n'
  ']\n'
  ...
  '\n'
  '\n'
  'def _safe17_line_part_near_point(geometry, contact_point):\n'
  ...
  '            return None\n'
  '\n'
  '        if contact_point is None or getattr(contact_point, "is_empty", True):\n'
  '            return max(parts, key=lambda part: part.length)\n'
  '\n'
  '        return min(parts, key=lambda part: part.distance(contact_point))\n'
  '\n'
  '    return None\n'
  '\n'
  '\n'
  'def _safe17_undirected_angle_difference(angle_1, angle_2):\n'
  '    difference = abs(float(angle_1) - float(angle_2)) % 180.0\n'
  '    return min(difference, 180.0 - difference)\n'
  '\n'
  '\n'
  'def _safe17_local_shape_metrics(geometry, contact_point, half_window_m):\n'
  '    """Measure local straightness and cumulative turning around contact."""\n'
  '    line = _safe17_line_part_near_point(geometry, contact_point)\n'
  '\n'
  '    if line is None or line.length <= 0:\n'
  '        return pd.Series(\n'
  '            {\n'
  '                "local_straightness": np.nan,\n'
  '                "local_net_turn_deg": np.nan,\n'
  '                "local_cumulative_turn_deg": np.nan,\n'
  '            }\n'
  '        )\n'
  '\n'
  '    if contact_point is None or getattr(contact_point, "is_empty", True):\n'
  '        projected_distance = float(line.length) / 2.0\n'
  '    else:\n'
  '        projected_distance = float(line.project(contact_point))\n'
  '\n'
  '    start_distance = max(\n'
  '        0.0,\n'
  '        projected_distance - float(half_window_m),\n'
  '    )\n'
  '    end_distance = min(\n'
  '        float(line.length),\n'
  '        projected_distance + float(half_window_m),\n'
  ...
  '                "local_net_turn_deg": 0.0,\n'
  '                "local_cumulative_turn_deg": 0.0,\n'
  '            }\n'
  '        )\n'
  '\n'
  '    local_segment = substring(\n'
  '        line,\n'
  '        start_distance,\n'
  '        end_distance,\n'
  '    )\n'
  ...
  '        or local_segment.is_empty\n'
  '        or local_segment.length <= 0\n'
  '    ):\n'
  '        return pd.Series(\n'
  '            {\n'
  '                "local_straightness": np.nan,\n'
  ...
  '        )\n'
  '\n'
  '    coordinates = list(local_segment.coords)\n'
  '\n'
  ...
  '\n'
  '    chord_length = float(start_point.distance(end_point))\n'
  '    local_straightness = float(\n'
  '        np.clip(\n'
  '            chord_length / float(local_segment.length),\n'
  '            0.0,\n'
  '            1.0,\n'
  '        )\n'
  '    )\n'
  ...
  '        cumulative_turn = 0.0\n'
  '    else:\n'
  '        net_turn = _safe17_undirected_angle_difference(\n'
  '            headings[0],\n'
  '            headings[-1],\n'
  '        )\n'
  '        cumulative_turn = float(\n'
  '            sum(\n'
  '                _safe17_undirected_angle_difference(first, second)\n'
  ...
  '            "local_net_turn_deg": net_turn,\n'
  '            "local_cumulative_turn_deg": cumulative_turn,\n'
  '        }\n'
  '    )\n'
  '\n'
  '\n'
  ...
  '\n'
  '# ============================================================\n'
  '# 13.5) Detect locally straight parallel / near-90-degree geometry\n'
  '# ============================================================\n'
  '\n'
  'local_metrics_1 = features_df.apply(\n'
  '    lambda row: _safe17_local_shape_metrics(\n'
  '        row["geometry_county1"],\n'
  '        row["county_1_contact_point"],\n'
  '        SAFE17_LOCAL_HALF_WINDOW_M,\n'
  '    ),\n'
  '    axis=1,\n'
  ')\n'
  'local_metrics_2 = features_df.apply(\n'
  '    lambda row: _safe17_local_shape_metrics(\n'
  '        row["geometry_county2"],\n'
  '        row["county_2_contact_point"],\n'
  '        SAFE17_LOCAL_HALF_WINDOW_M,\n'
  '    ),\n'
  '    axis=1,\n'
  ')\n'
  '\n'
  'features_df["safe17_local_straightness_1"] = local_metrics_1[\n'
  '    "local_straightness"\n'
  ']\n'
  'features_df["safe17_local_straightness_2"] = local_metrics_2[\n'
  '    "local_straightness"\n'
  ']\n'
  'features_df["safe17_local_net_turn_deg_1"] = local_metrics_1[\n'
  '    "local_net_turn_deg"\n'
  ']\n'
  'features_df["safe17_local_net_turn_deg_2"] = local_metrics_2[\n'
  '    "local_net_turn_deg"\n'
  ']\n'
  'features_df["safe17_local_cumulative_turn_deg_1"] = local_metrics_1[\n'
  '    "local_cumulative_turn_deg"\n'
  ']\n'
  'features_df["safe17_local_cumulative_turn_deg_2"] = local_metrics_2[\n'
  '    "local_cumulative_turn_deg"\n'
  ']\n'
  '\n'
  'locally_straight = (\n'
  '    features_df[\n'
  '        [\n'
  '            "safe17_local_straightness_1",\n'
  '            "safe17_local_straightness_2",\n'
  '        ]\n'
  '    ].min(axis=1)\n'
  '    >= SAFE17_MIN_LOCAL_STRAIGHTNESS\n'
  ') & (\n'
  '    features_df[\n'
  '        [\n'
  '            "safe17_local_cumulative_turn_deg_1",\n'
  '            "safe17_local_cumulative_turn_deg_2",\n'
  '        ]\n'
  '    ].max(axis=1)\n'
  '    <= SAFE17_MAX_LOCAL_CUMULATIVE_TURN_DEG\n'
  ')\n'
  '\n'
  'heading_difference = pd.to_numeric(\n'
  '    features_df["heading_diff_deg"],\n'
  '    errors="coerce",\n'
  ').fillna(90.0).clip(0.0, 90.0)\n'
  '\n'
  ...
  '    & (\n'
  '        heading_difference\n'
  '        <= SAFE17_PARALLEL_MAX_HEADING_DIFF_DEG\n'
  '    )\n'
  ')\n'
  'simple_orthogonal = (\n'
  '    locally_straight\n'
  '    & (\n'
  '        heading_difference\n'
  '        >= SAFE17_ORTHOGONAL_MIN_HEADING_DIFF_DEG\n'
  '    )\n'
  ')\n'
  '\n'
  'features_df["safe17_geometry_class"] = np.select(\n'
  '    [\n'
  '        simple_parallel,\n'
  '        simple_orthogonal,\n'
  '    ],\n'
  ...
  '        "SIMPLE_ORTHOGONAL",\n'
  '    ],\n'
  '    default="OTHER_OR_CURVED",\n'
  ')\n'
  '\n'
  '\n'
  '# ============================================================\n'
  '# 13.6) Apply the fixed calibrated thresholds\n'
  '# ============================================================\n'
  '\n'
  'base_global_reject = (\n'
  ...
  '        "locally_straight_parallel_below_specialized_threshold",\n'
  '        "locally_straight_near_90_below_specialized_threshold",\n'
  '    ],\n'
  ...
  ')\n'
  '\n'
  'features_df["safe17_applied_threshold"] = np.select(\n'
  '    [\n'
  '        simple_parallel,\n'
  '        simple_orthogonal,\n'
  '    ],\n'
  ...
  '        SAFE17_ORTHOGONAL_THRESHOLD,\n'
  '    ],\n'
  '    default=SAFE17_GLOBAL_THRESHOLD,\n'
  ').astype(float)\n'
  '\n'
  'features_df["safe17_score_minus_threshold"] = (\n'
  '    features_df[OUTPUT_PROBABILITY_COL]\n'
  '    - features_df["safe17_applied_threshold"]\n'
  ')\n'
  '\n'
  'features_df["safe17_global_threshold"] = SAFE17_GLOBAL_THRESHOLD\n'
  'features_df["safe17_parallel_threshold"] = SAFE17_PARALLEL_THRESHOLD\n'
  'features_df["safe17_orthogonal_threshold"] = SAFE17_ORTHOGONAL_THRESHOLD\n'
  '\n'
  ...
  ')\n'
  '\n'
  'safe_reject_layer_summary_df = pd.DataFrame(\n'
  '    [\n'
  '        [\n'
  '            "GLOBAL",\n'
  '            int(base_global_reject.sum()),\n'
  '            SAFE17_GLOBAL_THRESHOLD,\n'
  '        ],\n'
  '        [\n'
  '            "SIMPLE_PARALLEL_ADDITIONAL",\n'
  '            int(parallel_extra_reject.sum()),\n'
  '            SAFE17_PARALLEL_THRESHOLD,\n'
  '        ],\n'
  '        [\n'
  '            "SIMPLE_ORTHOGONAL_ADDITIONAL",\n'
  '            int(orthogonal_extra_reject.sum()),\n'
  '            SAFE17_ORTHOGONAL_THRESHOLD,\n'
  '        ],\n'
  '    ],\n'
  '    columns=[\n'
  ...
  'print()\n'
  'print("Thresholds use strict \'<\':")\n'
  'print(f"  Global:              {SAFE17_GLOBAL_THRESHOLD:.12f}")\n'
  'print(f"  Simple parallel:     {SAFE17_PARALLEL_THRESHOLD:.12f}")\n'
  'print(f"  Simple near-90 deg:  {SAFE17_ORTHOGONAL_THRESHOLD:.12f}")\n'
  'print()\n'
  ...
  'display(safe_reject_layer_summary_df)\n'),
